namespace LocalizationTools.ReSharper.I18n.Services.Services.CSharp.CustomReferences
{
    ...
    internal class PropertyReference<T> :
        ...
        ICompletableReference
    {
        ...
        public PropertyReference(ICSharpExpression expression, string resourceTypePropertyName)
            : base(expression)
        {
        ...
        public override ISymbolTable GetReferenceSymbolTable(bool useReferenceName)
        {
            ...
            return pair1.Second.TypeValue.GetSymbolTable(this.myOwner.GetPsiModule()).Filter(new PredicateFilter(info => info.GetDeclaredElement() is IProperty declaredElement && declaredElement.IsStatic && this.IsValidAccessRights(declaredElement.GetAccessRights()) && declaredElement.IsReadable && declaredElement.ReturnType.IsString()));
        }
